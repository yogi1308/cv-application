...
function GenericSubsection({setExperience, index, sectionIndex}) {
        ...
        <div className="more-experience-info-section" style={{paddingLeft: '1rem'}}>
            <div className="experience-name">
                <div className="subsection-name-and-dropdown" style={{paddingRight: '0.25rem'}}>
                    <h2>Name</h2>   
                    <div className="school-dropdown" onClick={(e) => {e.target.classList.toggle('rotated'); e.currentTarget.closest('.experience-name').nextElementSibling.classList.toggle('close')}} style={{ fontSize: '1.5rem' }}>▾</div>
                </div>
            ...
            <div className="add-delete-hide-subsection">
                ...
                <button className="hide" onClick={(e) => {handleFieldChange('hide', e)}} > <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d={eyeOpenPath}/></svg></button>
            </div>
        </div>
    )
}
