...
let show = true // remove this later
let showSkills = true // remove this later
...
function Sidebar({setShowExample, showExample, setName, setOtherPersonalDetails, setSummary, setShowSummary, setEducation, education, setShowSkills, setSkills, skills, setExperience, experiences}) {
  function handleShowSummary() {
    setShowSummary(prev => !prev)
    show = !show // remove this later
  }
  function handleShowSkills() {
    setShowSkills(prev => !prev)
    showSkills = !showSkills // remove this later
  }
  return ( 
  <>
